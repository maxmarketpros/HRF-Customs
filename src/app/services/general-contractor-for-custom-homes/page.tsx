...
export const metadata = {
    title: "General Contractor for Custom Homes | HRF Customs",
    description: "Learn more about General Contractor for Custom Homes from HRF Customs, the premier custom home builder.",
};
