...
export const metadata = {
    title: "Jackson Hole Region Wyoming | HRF Customs",
    description: "Learn more about Jackson Hole Region Wyoming from HRF Customs, the premier custom home builder.",
};
