...
export const metadata = {
    title: "Soda Springs Idaho Area | HRF Customs",
    description: "Learn more about Soda Springs Idaho Area from HRF Customs, the premier custom home builder.",
};
