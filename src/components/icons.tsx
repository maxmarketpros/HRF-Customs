...
export function HammerIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function ShovelIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function MountainSnowIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function ThermometerIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function HardHatIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            ...
            <path d="M10 15V6.5a1 1 0 0 1 .4-.8l.6-.45a2 2 0 0 1 2.36.12l.3.24a1 1 0 0 1 .34.75V15" />
            <path d="m18 15-.61-4.28a8 8 0 0 0-10.78 0L6 15" />
        </svg>
    );
}

export function FileCheckIcon({ className = "", size = 20 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
